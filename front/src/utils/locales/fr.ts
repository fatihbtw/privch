export default {
    ...
    'settings.homepage': "Page d'accueil par défaut",
    'settings.homepageSearch': 'Recherche',
    'settings.homepageFavorites': 'Favoris',
    'settings.homepageHint':
        '"Favoris" affiche tes favoris actuellement en direct directement sur la page d\'accueil.',
    'settings.notifications': 'Notifications pour les favoris',
    'settings.notificationsHint':
        "Notification du navigateur dès qu'un de tes favoris passe en direct. Fonctionne entièrement en local, aucun compte requis.",
    ...
    'settings.playbackSpeed': 'Vitesse de lecture par défaut (VODs)',
    ...
    'favorites.importCode': 'Importer un code de favoris',
    ...
    'stream.videos': 'Vidéos',
    'stream.clips': 'Clips',
    'stream.chat': 'Chat',
    'stream.noHls': 'Ton navigateur ne supporte pas le HLS.',
    'stream.theaterMode': 'Mode théâtre',

    'vod.invalid': 'VOD invalide.',
    'vod.startDownload': 'Démarrer le téléchargement',
    'vod.file': 'Fichier :',
    'vod.size': 'Taille : ~',
    'vod.of': 'sur',
    'vod.failed': 'échoués',

    'clips.notFoundTitle': 'Introuvable',
    'clips.notFoundDesc': 'Clip introuvable.',
    'clips.embeddedLink': 'Lien intégré',
    'clips.created': 'Créé',
    'clips.by': 'Par',
    'clips.views': 'Vues',

    'notifications.live': 'est en direct',

    'suggestions.title': 'Suggestions',
    'suggestions.viewers': 'spectateurs',

    'filters.archives': 'Archives',
    'filters.uploads': 'Téléversements',
    'filters.highlights': 'Moments forts',
    'filters.all': 'Tout',
    'filters.lastDay': 'Dernier jour',
